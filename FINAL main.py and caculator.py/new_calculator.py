    ...
    while not finished:
        ...
        while(not acknowledged):
            if (GPIO.input(13) == 0 and GPIO.input(14) == 1 and GPIO.input(15) == 1):
                ...
                return "Received Error"
            #else:
                            #print('waiting for magic powers...')
                            #time.sleep(5)
                            #print("ack operation: " + str(GPIO.input(13)) + str(GPIO.input(14)) + str(GPIO.input(15)))
                            #if GPIO.input(13) == 0 and GPIO.input(14) == 0 and GPIO.input(15) == 0:
                                #print('ack operation is all 0')
                                #time.sleep(100)
        ...
        for section in range(0, 8):
            ...
            while(not acknowledged):
                ...
                if section %2 == 1 and GPIO.input(13) == 1 and GPIO.input(14) == 0 and GPIO.input(15) == 1:
                    ...
                    return "Received Error"
                elif (GPIO.input(13) == 1 and GPIO.input(14) == 1 and GPIO.input(15) == 0):
                    reset_pins_to_low()
                    print("Overflow")
                    return "Overflow"
                else:
                                    #print("ack num1: " + str(GPIO.input(13)) + str(GPIO.input(14)) + str(GPIO.input(15)))
                                    #print("section: " + str(section))
                                    if GPIO.input(13) == 0 and GPIO.input(14) == 0 and GPIO.input(15) == 0:
                                        print('section: ' + str(section))
                                        print('ack num1 is all 0')
                                        time.sleep(0.1)
                # print("waiting for ack num1")
            acknowledged = False
        #print("sent num1 done")
        ...
        for section in range(0, 8):
            ...
            while(not acknowledged):
                ...
                if section %2 == 1 and GPIO.input(13) == 1 and GPIO.input(14) == 0 and GPIO.input(15) == 1:
                    ...
                    reset_pins_to_low()
                    print("Received error for ack num2")
                    return "Received Error"
                    ...
                    return "Debug"
                                    ...
                                    #print("ack num2: " + str(GPIO.input(13)) + str(GPIO.input(14)) + str(GPIO.input(15)))
                                    #print("section: " + str(section))
                                    if GPIO.input(13) == 0 and GPIO.input(14) == 0 and GPIO.input(15) == 0:
                                        print('section: ' + str(section))
                                        print('ack num2 is all 0')
                                        time.sleep(0.1)
                # print("waiting for ack num2")
            acknowledged = False
        #print("sent num2 done")
        ...
        #while(not acknowledged):
            ...
            #elif (GPIO.input(13) == 1 and GPIO.input(14) == 1 and GPIO.input(15) == 1):
            #    reset_pins_to_low()
            #    print("Received Error for first ack solution header")
            #    return "Received Error"
        ...
        #acknowledged = False
        #print("first solution header received")
        ...
        for section in range(0, 5):
            ...
            while not acknowledged:
                if section %2 == 0 and GPIO.input(13) == 0 and GPIO.input(14) == 0 and GPIO.input(15) == 1:
                    ...
                    reset_pins_to_low()
                    print("Received Error in solution header")
                    return "Received Error"
                elif (GPIO.input(13) == 0 and GPIO.input(14) == 1 and GPIO.input(15) == 1):
                    reset_pins_to_low()
                    print("Received Overflow")
                    return "Received Overflow"
                                    ...
                                    #print("solution header: " + str(GPIO.input(13)) + str(GPIO.input(14)) + str(GPIO.input(15)))
                                   # print("section: " + str(section))
                                    if GPIO.input(13) == 0 and GPIO.input(14) == 0 and GPIO.input(15) == 0:
                                        print('section: ' + str(section))
                                        print('solution header is all 0')
                                        time.sleep(0.1)
            # print("waiting for ack solution header")
            acknowledged = False
...
#for i in range(0, 10):
    ...
    # print(i)
     #time.sleep(2)
#while True:
    #formula = str(input("Enter the operation you want to perform: ")) 4+32*6
    #print(formula_to_array(formula))
